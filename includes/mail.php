...
function app_send_smtp_mail(
    ...
    try {
        ...
        $mail->SMTPAuth = true;
        $mail->Username = (string)(defined('SMTP_USERNAME') ? SMTP_USERNAME : '');
        $mail->Password = (string)(defined('SMTP_PASSWORD') ? SMTP_PASSWORD : '');
        ...
        $fromEmail = (string)(defined('SMTP_FROM_EMAIL') ? SMTP_FROM_EMAIL : 'no-reply@cantsaria.ru');
