...
<head>
    ...
    <title>PENPOINT - Интернет-магазин канцелярских товаров</title>
</head>
...
<body>
    ...
    <main class="main home-page">
        ...
        $recommended_products = array_slice(get_featured_products(10), 5, 5);
        if (empty($recommended_products)) {
            $recommended_products = get_featured_products(5);
        }
            ...
            <ul class="categories__list">
                <?php foreach ($categories as $cat): ?>
                    ...
                    <li class="categories__item">
                        <a href="/catalog.php?category=<?php echo htmlspecialchars($cat['slug']); ?>" class="categories__link">
