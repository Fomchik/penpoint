...
--
-- Хост: localhost
-- Время создания: Апр 18 2026 г., 16:30
...
ALTER DATABASE `penpoint` CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
INSERT INTO
    `delivery_methods` (`id`, `name`, `price`)
VALUES (1, 'Самовывоз', 0.00),
    (
        2,
        'Курьерская доставка',
        300.00
...
VALUES (
        1,
        12,
        'b0000cbb0e7fdb82ecc40f31374a4692ddac333d7c4b571c3542a0db3e24683a',
        '2026-04-09 16:12:38',
        NULL,
        '2026-04-08 13:12:38'
    );
...
CREATE TABLE `orders` (
    ...
    `payment_status` enum(
        ...
        'paid',
        'failed'
    ) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'not_required',
...
VALUES (
        1,
        1,
        'Шариковая ручка, синяя, 0.7 мм',
        'Шариковая ручка с качественным стержнем для повседневного письма.',
        84.00,
        4,
        NULL,
        0.0,
    ...
    (
        ...
        2,
        'Блокнот для заметок',
        'Качественный блокнот для заметок с плотной бумагой. Идеален для студентов и профессионалов.',
        420.00,
        87,
        NULL,
        0.0,
    ...
    (
        3,
        1,
        'Гелевая ручка черная',
        'Прецизионная гелевая ручка с ровным письмом. Пишет четко и ярко.',
        150.00,
        200,
        NULL,
        0.0,
    ...
    (
        ...
        2,
        'Линейка пластиковая',
        'Прозрачная пластиковая линейка для измерений и черчения. Удобна в использовании.',
        49.00,
        320,
        NULL,
        0.0,
    ...
    (
        ...
        3,
        'Рюкзак школьный',
        'Стильный и практичный школьный рюкзак с ортопедической спиной.',
        2870.00,
        42,
        NULL,
        0.0,
    ...
    (
        6,
        4,
        'Набор красок gouache',
        'Набор качественных гуашевых красок для творчества. Яркие и насыщенные цвета.',
        360.00,
        95,
        NULL,
        0.0,
    ...
    (
        ...
        4,
        'Набор маркеров',
        'Яркие маркеры для рисования и творчества. Не высыхают длительное время.',
        650.00,
        128,
        NULL,
        0.0,
    ...
    (
        ...
        'Надежный механический карандаш для черчения и письма. Удобен в использовании.',
        200.00,
        180,
        NULL,
        0.0,
    ...
    (
        ...
        'Удобный набор из множества цветов. Идеален для школы и творчества.',
        340.00,
        76,
        NULL,
        0.0,
    ...
    (
        ...
        2,
        'Ластик мягкий',
        'Универсальный ластик для карандаша. Стирает не оставляя следов.',
        75.00,
        250,
        NULL,
        0.0,
    ...
    (
        ...
        2,
        'Блокнот клеевой',
        'Удобный блокнот с клеевым слоем для быстрых заметок.',
        125.00,
        200,
        NULL,
        0.0,
    ...
    (
        ...
        4,
        'Палитра для красок',
        'Удобная палитра для смешивания красок и акварели.',
        95.00,
        180,
        NULL,
        0.0,
    ...
    (
        ...
        1,
        'Набор кистей',
        'Профессиональный набор кистей для живописи и творчества.',
        450.00,
        65,
        NULL,
        0.0,
    ...
    (
        ...
        'Высокачественный альбом с плотной бумагой для рисования.',
        280.00,
        110,
        NULL,
        0.0,
    ...
    (
        ...
        1,
        'Ножницы детские',
        'Безопасные ножницы для детей с округленными концами.',
        120.00,
        150,
        NULL,
        0.0,
    ...
    (
        ...
        3,
        'Пенал школьный',
        'Удобный пенал для хранения ручек и карандашей.',
        310.00,
        95,
        NULL,
        0.0,
    ...
    (
        ...
        5,
        'Клей-карандаш',
        'Клей-карандаш на основе PVP. Предназначен для склеивания бумаги всех типов, картона и фотографий. Не деформирует поверхность, не оставляет желтых пятен и комочков.',
        60.00,
        300,
        NULL,
        0.0,
...
--
-- Дамп данных таблицы `product_variant_values`
--
...
VALUES (
        1,
        1,
        '/assets/product_images/pens/ballpoint pen.webp'
    ),
    (
        2,
        2,
        '/assets/product_images/notebooks/notebook-12-sh.webp'
    ),
    (
        3,
        3,
        '/assets/product_images/pens/gel_pen_black.webp'
    ),
    (
        4,
        4,
        '/assets/product_images/ruler/ruler.webp'
    ),
    (
        5,
        5,
        '/assets/product_images/backpacks/backpack.webp'
    ),
    (
        6,
        6,
        '/assets/product_images/gouache/set-gouache.webp'
    ),
    (
        7,
        7,
        '/assets/product_images/markers/set-markers.webp'
    ),
    (
        8,
        8,
        '/assets/product_images/pencils/mechanical pencil.webp'
    ),
    (
        9,
        9,
        '/assets/product_images/pencils/set_pencil.webp'
    ),
    (
        10,
        10,
        '/assets/product_images/rubber/rubber.webp'
    ),
    (
        11,
        11,
        '/assets/product_images/notepads/notepad_white.webp'
    ),
    (
        12,
        12,
        '/assets/product_images/palette/color-palette.webp'
    ),
    (
        13,
        13,
        '/assets/product_images/brush/set-brush.webp'
    ),
    (
        14,
        14,
        '/assets/product_images/albums/album.webp'
    ),
    (
        15,
        15,
        '/assets/product_images/scissors/scissors-kid.webp'
    ),
    (
        16,
        16,
        '/assets/product_images/pencil-box/pencil-box.webp'
    ),
    (
        17,
        17,
        '/assets/product_images/glue-sctick/glue-stick.webp'
    );
...
VALUES (
        1,
        '30% на ручки, карандаши и блокноты',
        'Скидка на письменные принадлежности и блокноты',
        '/assets/banners/promo-writing.png',
        NULL,
        NULL,
        'regular',
        '2026-02-01',
    ...
    (
        2,
        '20% на краски, кисти и альбомы',
        'Товары для творчества по спеццене',
        '/assets/banners/promo-art.png',
        NULL,
        NULL,
        'regular',
        '2025-12-01',
    ...
    (
        4,
        '20% на категорию «органайзеры»',
        'Скидка на органайзеры и аксессуары для порядка',
        '/assets/banners/promo-organizers.png',
        NULL,
        NULL,
        'regular',
        '2025-11-01',
    ...
    (
        6,
        '20% на школьные принадлежности',
        'Скидка на ручки, тетради, папки, рюкзаки, линейки, пеналы, - собери всё в один набор',
        NULL,
        '/assets/banners/seasonal/main/2026/04/promo-main_20260415_175902_13e7ec2b0cfb.png',
        '/assets/banners/seasonal/list/2026/04/promo-list_20260415_175902_cf91dcd4a9b4.webp',
        'seasonal',
        '2026-04-15',
        '2026-04-30',
        20,
...
VALUES (
        ...
        'Admin',
        'cantsaria@yandex.ru',
        '$2y$12$MOlqTa2Wh4Uq5Bp1IHPaTu9H7Ctr4DStozbvHfXIUrNDMdL2/qrfG',
        NULL,
        0,
        NULL,
        '2026-01-01 10:05:00'
    ...
    (
        ...
        'Foma773',
        'rakvdele45@gmail.com',
        '$2y$12$KLH9R2.NTlJEeiwWeMy3POaTM/nQNOiPUcXdJTpQTft9k.VNuQvZu',
        NULL,
        0,
        NULL,
        '2026-04-08 13:12:38'
...
--
ALTER TABLE `delivery_methods` ADD PRIMARY KEY (`id`);
...
ADD PRIMARY KEY (`id`),
ADD UNIQUE KEY `uniq_order_product_variant` (
    `order_id`,
    `product_id`,
    `variant_id`
),
...
ADD PRIMARY KEY (`id`),
ADD KEY `idx_promotions_status_dates` (
    `status`,
    `date_start`,
    `date_end`
),
ADD KEY `idx_promotions_scope_dates` (
    `apply_scope`,
    `date_start`,
    `date_end`
),
...
CREATE ALGORITHM = UNDEFINED DEFINER = `root` @`%` SQL SECURITY DEFINER VIEW `v_active_promotions` AS
SELECT
    `v`.`id` AS `id`,
    `v`.`title` AS `title`,
    `v`.`short_text` AS `short_text`,
    `v`.`image_path` AS `image_path`,
    `v`.`apply_scope` AS `apply_scope`,
    `v`.`date_start` AS `date_start`,
    `v`.`date_end` AS `date_end`,
    `v`.`date_start_ru` AS `date_start_ru`,
    `v`.`date_end_ru` AS `date_end_ru`,
    `v`.`discount_percent` AS `discount_percent`
FROM `v_promotion_status` AS `v`
WHERE (
        (`v`.`date_start` <= curdate())
        AND (
            isnull(`v`.`date_end`)
            OR (`v`.`date_end` >= curdate())
        )
    );
...
CREATE ALGORITHM = UNDEFINED DEFINER = `root` @`%` SQL SECURITY DEFINER VIEW `v_invalid_active_promotions` AS
SELECT `p`.`id` AS `promotion_id`
FROM `promotions` AS `p`
WHERE (
        (
            curdate() between `p`.`date_start` and `p`.`date_end`
        )
        AND (
            (
                (
                    `p`.`apply_scope` = 'products'
                )
                AND (
                    not(
                        exists (
...
CREATE ALGORITHM = UNDEFINED DEFINER = `root` @`%` SQL SECURITY DEFINER VIEW `v_product_active_discounts` AS
SELECT
...
CREATE ALGORITHM = UNDEFINED DEFINER = `root` @`%` SQL SECURITY DEFINER VIEW `v_product_applicable_promotions` AS
SELECT
    `s`.`product_id` AS `product_id`,
    `ap`.`id` AS `promotion_id`,
    `ap`.`discount_percent` AS `discount_percent`
FROM (
        `v_promotion_scope_products` `s`
        join `v_active_promotions` `ap` on (
            (
                `ap`.`id` = `s`.`promotion_id`
            )
        )
    );
...
CREATE ALGORITHM = UNDEFINED DEFINER = `root` @`%` SQL SECURITY DEFINER VIEW `v_product_best_discount` AS
SELECT
    `ap`.`product_id` AS `product_id`,
    min(`ap`.`promotion_id`) AS `promotion_id`,
    `ap`.`discount_percent` AS `discount_percent`
FROM (
        `v_product_applicable_promotions` `ap`
        join (
            select
                `v_product_applicable_promotions`.`product_id` AS `product_id`, max(
                    `v_product_applicable_promotions`.`discount_percent`
                ) AS `discount_percent`
            from
                `v_product_applicable_promotions`
            group by
                `v_product_applicable_promotions`.`product_id`
        ) `best` on (
            (
                (
                    `best`.`product_id` = `ap`.`product_id`
                )
                and (
                    `best`.`discount_percent` = `ap`.`discount_percent`
                )
            )
        )
    )
...
CREATE ALGORITHM = UNDEFINED DEFINER = `root` @`%` SQL SECURITY DEFINER VIEW `v_product_final_prices` AS
SELECT
    `pr`.`id` AS `id`,
    `pr`.`name` AS `name`,
    `pr`.`price` AS `price`,
    ...
    (
        `pr`.`price` * (
            1 - (
                coalesce(`d`.`discount_percent`, 0) / 100
            )
        )
    ) AS `final_price`
FROM (
        `products` `pr`
        left join `v_product_active_discounts` `d` on (
            (`d`.`product_id` = `pr`.`id`)
        )
    );
...
CREATE ALGORITHM = UNDEFINED DEFINER = `root` @`%` SQL SECURITY DEFINER VIEW `v_product_pricing` AS
SELECT
    `p`.`id` AS `id`,
    ...
    `p`.`pickup_available` AS `pickup_available`,
    `p`.`rating` AS `rating`,
    `p`.`is_active` AS `is_active`,
    `p`.`created_at` AS `created_at`,
    `p`.`updated_at` AS `updated_at`,
    COALESCE(
        MAX(`bd`.`discount_percent`),
        0
    ) AS `discount_percent`,
    MIN(`bd`.`promotion_id`) AS `promotion_id`,
    (
        CASE
            WHEN MAX(`bd`.`promotion_id`) IS NULL THEN 0
            ELSE 1
        END
...
FROM
    `products` `p`
    LEFT JOIN `v_product_best_discount` `bd` ON (`bd`.`product_id` = `p`.`id`)
GROUP BY
    `p`.`id`;
...
CREATE ALGORITHM = UNDEFINED DEFINER = `root` @`%` SQL SECURITY DEFINER VIEW `v_promotion_scope_products` AS
SELECT
    `pp`.`promotion_id` AS `promotion_id`,
    `pp`.`product_id` AS `product_id`
FROM `promotion_products` AS `pp`
union all
select
    `pc`.`promotion_id` AS `promotion_id`,
    `p`.`id` AS `product_id`
from (
        `promotion_categories` `pc`
        join `products` `p` on (
            (
...
CREATE ALGORITHM = UNDEFINED DEFINER = `root` @`%` SQL SECURITY DEFINER VIEW `v_promotion_status` AS
SELECT
    `p`.`id` AS `id`,
    `p`.`title` AS `title`,
    `p`.`short_text` AS `short_text`,
    `p`.`image_path` AS `image_path`,
    `p`.`apply_scope` AS `apply_scope`,
    `p`.`date_start` AS `date_start`,
    `p`.`date_end` AS `date_end`,
    date_format(`p`.`date_start`, '%d.%m.%Y') AS `date_start_ru`,
    (
        case
            when isnull(`p`.`date_end`) then NULL
            else date_format(`p`.`date_end`, '%d.%m.%Y')
        end
    ) AS `date_end_ru`,
    `p`.`discount_percent` AS `discount_percent`,
    `p`.`status` AS `status_cache`,
    (
        case
            when (`p`.`date_start` > curdate()) then 'draft'
            when (
